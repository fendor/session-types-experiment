...
instance {-# OVERLAPPABLE #-} (Show (Var k), Show v) => Show (k :-> v) where
  show (k :-> v) = "(" ++ show k ++ " :-> " ++ show v ++ ")"
instance {-# OVERLAPPING #-} Show (Var "x") where
  show X = "x"
  show Var = "Var"
instance {-# OVERLAPPING #-} Show (Var "y") where
  show Y = "y"
  show Var = "Var"
instance {-# OVERLAPPING #-} Show (Var "z") where
  show Z = "z"
  show Var = "Var"
